...
describe('InfoSection', () => {
  it('renders number badge', () => {
    render(<InfoSection number={'1'} title="Test Title" description="Test Description" />);
  ...
  it('renders all numbers correctly', () => {
    const { rerender } = render(
      <InfoSection number={'1'} title="First" description="First section" />,
    );

    expect(screen.getByText('1')).toBeInTheDocument();

    rerender(<InfoSection number={'2'} title="Second" description="Second section" />);
  ...
  it('renders with correct structure', () => {
    const { container } = render(
      <InfoSection number={'1'} title="Test Title" description="Test Description" />,
    );
