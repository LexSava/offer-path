...
describe('ApplicationSearchInput', () => {
  it('renders search input', () => {
    render(
      <ApplicationSearchInput value="" onChange={vi.fn()} />
    );
  ...
  it('displays current value', () => {
    render(
      <ApplicationSearchInput value="test search" onChange={vi.fn()} />
    );
  ...
  it('calls onChange when text is entered', async () => {
    ...
    render(
      <ApplicationSearchInput value="" onChange={handleChange} />
    );
  ...
  it('updates value on input change', async () => {
    ...
    rerender(
      <ApplicationSearchInput value="t" onChange={handleChange} />
    );
